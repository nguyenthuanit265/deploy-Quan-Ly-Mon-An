...
public class Product {
	...
	public Product(int id, String name, int quantity, float price, Date dateProduct, boolean isBeverage, int statusId, boolean isDelete, String imageUrl) {
	...
	public Product(String name, int quantity, float price, Date dateProduct, boolean isBeverage, int statusId, boolean isDelete,String imageUrl) {
